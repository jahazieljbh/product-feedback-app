...
const Dashboard = () => {
  ...
  const searchFeedbacks = () => {
    if (search.trim()) {
      ...
      history(`/feedbacks/search?query=${search || "none"}`);
    } else {
  ...
  return (
    <main className="grid grid-cols-1 lg:grid-cols-body gap-x-10 gap-y-0 md:gap-y-5 lg:gap-y-0 md:px-5 md:py-16 w-full mx-auto md:max-w-4xl lg:max-w-5xl overflow-x-hidden overflow-y-hidden">
