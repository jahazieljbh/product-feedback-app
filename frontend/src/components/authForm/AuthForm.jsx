...
import AvatarsScroll from "../helpers/AvatarsScroll";
  ...
  return (
    <section className="mx-auto w-full max-w-md my-16 px-2 sm:px-5">
      <Helmet>
        ...
        <meta
          name="description"
          content="Login or Signup a user"
        />
      </Helmet>
      <PageHeader />
            ...
            <div>
              {!isLogin && (
                <div>
                  ...
                  <Input inputName="name" type="text" autoComplete="given-name" />
                </div>
              )}
              <div>
                <Label labelName="Email" labelFor="email" />
                <Input inputName="email" type="email" autoComplete="email" />
              </div>
              <div>
              ...
              {!isLogin && (
                <div>
                  <Label labelName="Select your avatar"/>
                  <AvatarsScroll
                    selected={selected}
